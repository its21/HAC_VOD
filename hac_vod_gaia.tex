...
%
% For the Sun's motion, $\texttt{astropy}$ assumes a local standard of rest velocity of 220 km s and Solar peculiar motion of (U, V, W) = (11.1, 12.2, 7.3) km/s.
%
\begin{figure}
  ...
  \includegraphics[scale=0.55]{VOD_allv.pdf}
   ...
   \vspace{-0.45cm}
    \caption{Velocity distribution in spherical polar coordinates
      ...
      Gr. ~2 and VOD(11-16) sub-samples are also shown (see Fig.\ref{fig:lb}). }%Vivas Group~2 clusters lie at $v_{r} =135$ km/s, as expected, while the VOD(11-16) group largely belongs to the high-anisotropy component (in blue).}
    \label{fig:vel}
\end{figure}
%
...
%
   ...
   \caption{Distribution of the angular momentum components,
     ...
     for the HAC (black circles), VOD (gray dots), Vivas Gr. 2  (lime) and VOD(11-16) (red).} %A large number of HAC and VOD(11-16) RRL are concentrated at high energy E$\sim$-100000 km$^{2}$/s$^{2}$ but low angular momentum L$\sim$0-500 km/s kpc.}
    \label{fig:energy}
\end{figure}
%
...
\section{Conclusions}
%
Using a sample of $\sim$350 RRL with full 6-D phase space
...
CRTS RRL dataset to select targets for spectroscopic follow-up
...
n. 308024 and PIFI Grant n. 2018PM0050. ITS and SEK thank the Center for Computational Astrophysics
for hospitality.
