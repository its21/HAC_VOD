...
\begin{figure}
	...
	% Allowable file formats are eps or ps if compiling using latex
	% or pdf, png, jpg if compiling using pdflatex
	\includegraphics[scale=0.395]{vtot_r.pdf}
		       	       \includegraphics[scale=0.395]{E_L.pdf}
		       	       	       	       \includegraphics[scale=0.395]{Lz_Lp.pdf}
		       	       	       	       \vspace{-0.4cm}
   \caption{angular momentum - I can combine these two and also add another panel with energy vs total L when I figure out the energy.}
    \label{fig:l}
\end{figure}
\section{Conclusions}
