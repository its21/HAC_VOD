...
\vspace{-0.4cm}
    \caption{RRL velocity distribution in spherical polar coordinates
      ...
      polar components respectively) of the HAC/VOD RR Lyrae, in the top/bottom rows. The error bars are the upper limit velocity uncertainties estimated through error propagation. The orbital anisotropy, is
