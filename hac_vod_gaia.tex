...
\begin{figure}
	...
	%\hspace{-0.3cm}
	     %   	        \includegraphics[scale=0.55]{VOD_velocities_vphi_dcuts.pdf}
\vspace{-0.45cm}
   ...
   \begin{figure}
	%\includegraphics[scale=0.398]{vtot_r.pdf}
        ...
        \includegraphics[scale=0.4035]{E_L.pdf}
		       	       	       	       \vspace{-0.45cm}
   \caption{Distribution of the angular momentum components, $L_{\perp}$ and $L_{z}$,  for the HAC (left panel) and VOD (middle panel) RR Lyrae. Notice the clear prevalence of retrograde orbits for the HAC and VOD(11-16) group, shown in red. We also show the total angular momentum as a function of energy (right panel) for the HAC (black circles), VOD (gray dots) and the two VOD sub-samples, `Vivas Gr. 2' and VOD(11-16) in lime and red. A large number of HAC and VOD(11-16) RR Lyrae are concentrated at E$\sim$-100000 km$^{2}$/s$^{2}$ and L$\sim$0-500 km/s kpc.}
    \label{fig:energy}
\end{figure}
%
...
\vspace{-0.45cm}
   \caption{Backward orbit integration for HAC (top panels) and VOD (middle panels) for 8 Gyrs. We show a density plot of the test particle positions along their individual orbits across the past 8 Gyrs, in Galactic coordinates (left panels) and in the x-y and y-z Galactic planes. In the bottom panels we show the VOD orbits only for the `sausage' component. It is useful to compare this figure obtained from actual observations to a simulated accretion event shown in figure 7 of \citet{Simion2018}: they look very similar.}
