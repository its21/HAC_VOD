...
fields. To compute  $v_{r}$, $v_{\theta}$ and $v_{\phi}$ we have used $\texttt{astropy}$ \citep{astropy} with its default values for the Sun's motion. In the figure, Group 2 stars (green) can be seen clustering at $v_{r} = 135$
