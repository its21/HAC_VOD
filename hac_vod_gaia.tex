...
%
   \begin{figure}
	%\includegraphics[scale=0.398]{vtot_r.pdf}
	        \includegraphics[scale=0.402]{HAC_Lz_Lp.pdf}
	    \includegraphics[scale=0.402]{VOD_Lz_Lp.pdf}
        \includegraphics[scale=0.40]{E_L.pdf}
		       	       	       	       \vspace{-0.4cm}
   \caption{Distribution of the $L_{\perp}$ and $L_{z}$ components of the angular momentum for the HAC (left panel) and VOD (middle panel). The right panel shows the distribution of the total angular momentus as a function of energy for all the stars in the HAC and VOD fields.}
    \label{fig:energy}
\end{figure}
%
